...
private:
    ...
    {
        if (rigidBodyType == RigidBodyType::StaticBody || rigidBodyType == RigidBodyType::KinematicBody || mass == 0.0f) {
            ...
            if (rigidBodyType == RigidBodyType::KinematicBody) {
                m_rigidBodyPtr->setCollisionFlags(m_rigidBodyPtr->getCollisionFlags() | btCollisionObject::CF_KINEMATIC_OBJECT);
