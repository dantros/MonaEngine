...
public:
    ...
    BaseComponentHandle(InnerComponentHandle handle)
...
public:
    ...
    ComponentHandle()
        : BaseComponentHandle()
        , m_managerPointer(nullptr)
    {
    }
    ComponentHandle(InnerComponentHandle handle, ComponentManager<ComponentType>* manager)
        : BaseComponentHandle(handle)
        , m_managerPointer(manager)
    {
    }
    InnerComponentHandle GetInnerHandle() const noexcept { return m_innerHandle; }
