...
public:
	...
	void UserStartUp(Mona::World& world) noexcept override {
		...
		auto skeleton = skeletonManager.LoadSkeleton(config.SourcePath("Assets/Models/xbot.fbx"));
		auto skinnedMesh = meshManager.LoadSkinnedMesh(skeleton, config.SourcePath("Assets/Models/xbot.fbx"));
		m_animation0 = animationManager.LoadAnimationClip(config.SourcePath("Assets/Animations/xbot/running.fbx"), skeleton);
		m_animation1 = animationManager.LoadAnimationClip(config.SourcePath("Assets/Animations/xbot/walking0.fbx"), skeleton);
		m_animation2 = animationManager.LoadAnimationClip(config.SourcePath("Assets/Animations/xbot/idle.fbx"), skeleton);
...
public:
	...
	void UserStartUp(Mona::World& world) noexcept override {
		...
		auto& config = Mona::Config::GetInstance();
		std::shared_ptr<Mona::Mesh> model = meshManager.LoadMesh(config.SourcePath("Assets/Models/Survival_BackPack_2.fbx"), true);
		...
		std::shared_ptr<Mona::Texture> albedo = textureManager.LoadTexture(config.SourcePath("Assets/Textures/BackpackFBX/1001_albedo.jpg"));
		std::shared_ptr<Mona::Texture> normalMap = textureManager.LoadTexture(config.SourcePath("Assets/Textures/BackpackFBX/1001_normal.png"));
		std::shared_ptr<Mona::Texture> metallic = textureManager.LoadTexture(config.SourcePath("Assets/Textures/BackpackFBX/1001_metallic.jpg"));
		std::shared_ptr<Mona::Texture> roughness = textureManager.LoadTexture(config.SourcePath("Assets/Textures/BackpackFBX/1001_roughness.jpg"));
		std::shared_ptr<Mona::Texture> ambientOcclusion = textureManager.LoadTexture(config.SourcePath("Assets/Textures/BackpackFBX/1001_AO.jpg"));
...
public:
	...
	void UserStartUp(Mona::World& world) noexcept override {
		...
		auto& textureManager = Mona::TextureManager::GetInstance();
		auto& config = Mona::Config::GetInstance();
		std::shared_ptr<Mona::Mesh> model = meshManager.LoadMesh(config.SourcePath("Assets/Models/drakefire_pistol_low.obj"),true);
		...
		std::shared_ptr<Mona::Texture> albedo = textureManager.LoadTexture(config.SourcePath("Assets/Textures/DrakePistolOBJ/base_albedo.jpg"));
		std::shared_ptr<Mona::Texture> normalMap = textureManager.LoadTexture(config.SourcePath("Assets/Textures/DrakePistolOBJ/base_normal.jpg"));
		std::shared_ptr<Mona::Texture> metallic = textureManager.LoadTexture(config.SourcePath("Assets/Textures/DrakePistolOBJ/base_metallic.jpg"));
		std::shared_ptr<Mona::Texture> roughness = textureManager.LoadTexture(config.SourcePath("Assets/Textures/DrakePistolOBJ/base_roughness.jpg"));
		std::shared_ptr<Mona::Texture> ambientOcclusion = textureManager.LoadTexture(config.SourcePath("Assets/Textures/DrakePistolOBJ/base_AO.jpg"));
