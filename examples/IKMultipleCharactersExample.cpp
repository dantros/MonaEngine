...
Mona::GameObjectHandle<Mona::GameObject> AddTerrain(Mona::World& world)
{
    ...
    world.AddComponent<Mona::StaticMeshComponent>(terrain, meshManager.GenerateTerrain(minXY, maxXY, numInnerVerticesWidth, numInnerVerticesHeight, heighFunc), materialPtr);
    return terrain;
}
...
public:
    ...
    virtual void UserStartUp(Mona::World& world) noexcept
    {
        ...
        m_walkingAnimation = animationManager.LoadAnimationClip(config.getPathOfApplicationAsset("Animations/" + m_characterName + "/walking"
                                                                    + std::to_string(m_walkingAnimIndex) + ".fbx"),
            skeleton, false);
