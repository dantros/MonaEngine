...
{
    return ((m_bDrawWireframe ? ~0u : 0) & btIDebugDraw::DebugDrawModes::DBG_DrawWireframe) | ((m_bDrawContactsPoints ? ~0u : 0) & BulletDebugDraw::DBG_DrawContactPoints) | ((m_bDrawAABB ? ~0u : 0) & btIDebugDraw::DebugDrawModes::DBG_DrawAabb);
}
