...
public:
    friend class World;
    BaseGameObjectHandle()
        : m_innerHandle()
        , m_objectPointer(nullptr)
    {
    }
    BaseGameObjectHandle(InnerGameObjectHandle handle, GameObject* object)
        : m_innerHandle(handle)
        , m_objectPointer(object)
    {
    }
...
public:
    ...
    GameObjectHandle(InnerGameObjectHandle handle, ObjectType* object)
        : BaseGameObjectHandle(handle, object)
    {
    }
